  ...
  data(){
    return {
      ...
      tableData: [
        ...
        {
          param: 'fileList',
          introduce: '上传的文件列表, 接口需返回的文件参数 {originalFileName: "源文件名称", fileLink: "文件地址", fileName: "生成文件名称"}',
          type: 'array',
          value: '-',
          default: '-'
        },
