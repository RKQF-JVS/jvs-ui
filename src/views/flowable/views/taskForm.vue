<template>
  <div class="task-form">
    <jvs-tab class="task-tab" :active="active" :option="taskFormType == 'view' ? viewOption : tabOption" size="mini">
      <template slot="form">
        <div>
          <iframe
            :src="formUrl"
...
export default {
  ...
  async created () {
    ...
    // 办理
      ...
      if(this.taskDataInfo.formId) {
        this.formUrl = `/page-design-ui/#/form/info?id=${this.taskDataInfo.formId}&dataModelId=${this.rowData.dataModelId}&formType=flowable`
